...
static const char *fonts[]          = {"Monospace:pixelsize=9:antialias=true:autohint=true", "Noto Color Emoji:pixelsize=10:antialias=true:autohint=true"};
...
static Key keys[] = {
	...
	{0, XF86XK_AudioRaiseVolume,    spawn,     SHCMD("pamixer -i 5 && refbar") },
	{0, XF86XK_AudioLowerVolume,    spawn,     SHCMD("pamixer -d 5 && refbar") },
	{0, XF86XK_AudioMute,           spawn,     SHCMD("pamixer -t && refbar") },
	{0, XF86XK_AudioPrev,           spawn,     SHCMD("mpc prev && refbar") },
	{0, XF86XK_AudioNext,           spawn,     SHCMD("mpc next && refbar") },
	{0, XF86XK_MonBrightnessDown,   spawn,     SHCMD("brightness down") },
	{0, XF86XK_MonBrightnessUp,     spawn,     SHCMD("brightness up") },
	{0, XF86XK_AudioPlay,           spawn,     SHCMD("mpc toggle") },
	{0, XK_Print,                   spawn,     SHCMD("scrot /mnt/ext/Media/Pix/screenshots/o.png") },
	{ControlMask, 			XF86XK_AudioRaiseVolume,    spawn,     SHCMD("mpc volume +5") },
	{ControlMask, 			XF86XK_AudioLowerVolume,    spawn,     SHCMD("mpc volume -5") },
	{ControlMask,                   XK_Print,  spawn,          SHCMD("scrot -s /mnt/ext/Media/Pix/screenshots/o.png") },
	...
	{MODKEY|ControlMask|ShiftMask, 	XK_t, 	   spawn, 	   SHCMD("steam steam://rungameid/440")},
	{MODKEY|ControlMask, 		XK_t, 	   spawn, 	   SHCMD("wallpapers")},
	{MODKEY|ControlMask, 		XK_y,      spawn, 	   SHCMD("st -e newsboat")},
